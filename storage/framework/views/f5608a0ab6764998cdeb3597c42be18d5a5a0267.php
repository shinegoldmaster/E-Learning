                        ...
                        <div id="section-10">
							<div class="homework-history">
								...
								<div class="section-title bg-blue">
									<h3><?php echo e(trans('instructor.Messages_History')); ?></h3>
								</div>
											...
											<div class="disable-body">
												<div class="display-table">
													<div class="display-cell">
														<p class="text-center">
															<?php echo e(trans('instructor.There_NO_received_messages')); ?>
								...
								<div class="row">
									<form method="POST" action="/instructor/msgs-received" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
								...
								<div class="padding-right-20 padding-left-20 text-center">
									<table class="table table-bordered table-responsive">
										<thead>
											<tr>
												<td>#</td>
												<th><?php echo e(trans('instructor.Message_Subject')); ?></th>
												<th><?php echo e(trans('instructor.Message')); ?> </th>
												<th><?php echo e(trans('instructor.Receiver')); ?> </th>
										...
										<?php $__currentLoopData = $messagehistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr>
												...
												<td><a href="#" class="btn btn-blue" data-toggle="modal" data-target="#msg_<?php echo e($item->id); ?>"><?php echo e(trans('instructor.Show_Message')); ?></a></td>
										...
										<div class="modal-dialog">
											...
											<div class="modal-content">
												<div class="modal-header">
													...
													<h4 class="modal-title"><?php echo e(trans('instructor.Message')); ?></h4>
												</div>
