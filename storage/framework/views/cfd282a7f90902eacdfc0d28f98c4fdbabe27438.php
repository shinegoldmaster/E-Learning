                    ...
                    <div class="tab-content">
                        ...
                        <div id="section-10">
							<div class="homework-history">							  				<?php if($errors->any()): ?>							
								...
								<div class="row">
									<form method="POST" action="/student/msgs-received" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
									...
									<table class="table table-bordered table-responsive">
										...
										<?php $__currentLoopData = $messagehistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr>
												...
												<td><a href="#" class="btn bg-blue" data-toggle="modal" data-target="#msg_<?php echo e($item->id); ?>"><?php echo e(trans('student.Show_Message')); ?></a></td>
