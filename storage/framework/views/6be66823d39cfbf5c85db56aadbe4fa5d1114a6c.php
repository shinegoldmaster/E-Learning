...
– المسار الثاني : تحفيظ السنة والمتون العلمية ( رجال – نساء )
	">
		...
		<link href="<?php echo e(asset('css/aplayer/player.css')); ?>" rel="stylesheet">
						...
						<div class="container">
							<div class="navbar-header">
								...
								<a class="navbar-brand waves-effect waves-light _v2 logo-header" href="/">
									<img src="<?php echo e(asset('images/logo.png')); ?>" class="" alt="">
								</a>
							</div>
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
								<ul class="nav navbar-nav navbar-right">
									...
									<li class="qlibrarys"><a href="/quran" class="waves-effect"><?php echo e(trans ('global.quran_libaray')); ?></a></li>
									<li class="librarys"><a href="/librarys" class="waves-effect"><?php echo e(trans ('global.library')); ?></a></li>
									<li class="newss"><a href="/news" class="waves-effect"><?php echo e(trans ('global.news')); ?></a></li>
									...
									<?php if(Route::has('login')): ?>
										...
										<?php if(Auth::check()): ?>
											<?php if(Auth::user()->status == 0): ?>
												<li class="students"><a href="/student" class="waves-effect"><?php echo e(trans ('global.student')); ?>&nbsp;<?php echo e(trans ('global.dashboard')); ?></a></li>
											<?php elseif(Auth::user()->status == 1): ?>
												<li class="instructors"><a href="/instructor" class="waves-effect"><?php echo e(trans ('global.instructor')); ?>&nbsp;<?php echo e(trans ('global.dashboard')); ?></a></li>
											<?php elseif(Auth::user()->status == 2): ?>
												<li class="instructors"><a href="/moderator/dashboard" class="waves-effect"><?php echo e(trans ('global.moderator')); ?>&nbsp;<?php echo e(trans ('global.dashboard')); ?></a></li>
											<?php else: ?>
												<li class="instructors"><a href="/admin/dashboard" class="waves-effect"><?php echo e(trans ('global.admin')); ?>&nbsp;<?php echo e(trans ('global.dashboard')); ?></a></li>
											<?php endif; ?>
											<li>
												<a href="<?php echo e(route('logout')); ?>"	onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
													<?php echo e(trans ('global.sign_out')); ?>
										...
										<?php else: ?>
											<li class="logins"><a id="loginformodal" href="#" data-toggle="modal" data-target="#modalLogin" class="waves-effect"><?php echo e(trans ('global.login')); ?></a></li>
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="row">
										<span id="loginModaleMessage">
											<?php if($errors -> count()): ?>	
												<?php $errorhaslogin = 1; ?>
												<div class="alert alert-danger text-center" style="padding: 20px;margin: 20px;width: 90%;display: inline-table;"><p><?php echo e(trans ('login.Incorrect_email_password')); ?></p> </div>								
											<?php endif; ?>
										...
										<form class="col-md-12" role="form" method="POST" action="<?php echo e(route('login')); ?>">
											...
											<div class="row">
												...
												<div class="text-center margin-top-10">
													<button type="submit" class="btn btn-blue	 btn-block waves-effect" style="width: 100px;"><?php echo e(trans ('global.login')); ?></button>
												</div>
								...
								<div class="modal-footer">
									<button id="close" type="submit" class="btn btn-warning pull-left" data-dismiss="modal"><?php echo e(trans ('global.close')); ?></button>
									<div id="forget-password" class="options pull-right">
									   <a class="btn btn-danger waves-effect waves-light" href="<?php echo e(route('password.request')); ?>">
