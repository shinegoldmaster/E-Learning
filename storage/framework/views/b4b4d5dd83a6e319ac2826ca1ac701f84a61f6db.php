...
<section class="profile">
    ...
    <div class="section-title bg-blue">
        <h3><?php echo e(trans('student.My_Info')); ?></h3>
    </div>
    <div id="user-info" class="register">
		...
		<?php $__currentLoopData = $studentInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
                <div class="section-title bg-blue">
                    <h3><?php echo e(trans('student.Basic_informations')); ?> </h3>
                </div>
                <div class="input-field col-md-6 col-sm-6 col-xs-12 ">
                    ...
                    <label for="first_name1" class="active"><?php echo e(trans('student.First_Name')); ?></label>
                ...
                <div class="input-field col-md-6 col-sm-6 col-xs-12 ">
                    ...
                    <label for="last_name1" class="active"><?php echo e(trans('student.Last_Name')); ?></label>
                    <span class="help-block">                        
                    </span>
                </div>
                ...
                <div class="input-field col-md-6 col-sm-6 col-xs-12">
                    ...
                    <label for="username" class="active"><?php echo e(trans('student.Username')); ?></label>
                </div>

                <div class="input-field col-md-6 col-sm-6 col-xs-12">
                    <input name="email1" id="email1" value="<?php echo e($item->email); ?>" placeholder="Email" class="validate" type="email">                            
                    </span>
                    <label for="email1" class="active"><?php echo e(trans('student.Email')); ?></label>
                </div>
                ...
                <div class="input-field col-md-6 col-sm-6 col-xs-12">
                    ...
                    <label for="newpass" class="active"><?php echo e(trans('student.New_password')); ?></label>
                </div>
                ...
                <div class="input-field col-md-6 col-sm-6 col-xs-12">
                    ...
                    <label for="renewpass" class="active"><?php echo e(trans('student.Reenter_new_password')); ?></label>
                </div>
                        ...
                        <div class="box">						  
						  <select class="wide" id="gender" name="gender" required>
							<?php if($item->gender == 1): ?>
								<option value="1" selected><?php echo e(trans('student.male')); ?></option>
								<option value="2"><?php echo e(trans('student.female')); ?></option>
							<?php else: ?>
								<option value="1"><?php echo e(trans('student.male')); ?></option>
								<option value="2" selected><?php echo e(trans('student.female')); ?></option>
							<?php endif; ?>
						  </select>
						  <label for="gender" class="active mt15"><?php echo e(trans('student.Gender')); ?>:</label>
						</div>
                ...
                <div class="input-field  col-md-6 ol-sm-6 col-xs-12 " style="padding-right: 0;margin-top: 20px;" >
                        ...
                        <div class="box">
						  ...
						  <label for="language" class="active  mt15"><?php echo e(trans('student.Language')); ?>:</label>
						</div>
                ...
                <div class="input-field col-md-6 col-sm-6 col-xs-12">
                    ...
                    <label for="age1" class="active"><?php echo e(trans('student.Age')); ?></label>
                </div>
                ...
                <div class="input-field col-md-6 col-sm-6 col-xs-12" style="padding-right: 0;margin-top: 20px;">
                   <div class="box">					  
					  ...
					  <label for="country1"  class="active  mt15"><?php echo e(trans('student.Country')); ?>:</label>
					</div>
                </div>
                <div class="clearfix"></div>
            </div>
			...
			<div class="row more-info">
				<div class="col-md-8 col-md-offset-2 col-sm-12">
					<div class="section-title bg-warning">
						<h3><?php echo e(trans('student.Your_Connections')); ?> </h3>
					</div>
					<div class="input-field col-md-6 col-sm-6 col-xs-12">
						<input id="cwhatsapp" name="cwhatsapp" value="" type="text">
						<label for="cwhatsapp"><?php echo e(trans('student.whatsapp')); ?></label>
					</div>
					<div class="input-field col-md-6 col-sm-6 col-xs-12">
						<input id="csoma" name="csoma" value="" type="text">
						<label for="csoma"><?php echo e(trans('student.soma')); ?></label>
					</div>
					<div class="input-field col-md-6 col-sm-6 col-xs-12">
						<input id="cline" name="cline" value="" type="text">
						<label for="cline"><?php echo e(trans('student.line')); ?></label>
					</div>
					<div class="input-field col-md-6 col-sm-6 col-xs-12">
						<input id="cviber" name="cviber" value="" type="text">
						<label for="cviber"><?php echo e(trans('student.viber')); ?></label>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>	
			...
			<div class="row buttons">
				<div class="col-md-12 col-md-offset-4 col-xs-12">
					<div class="col-md-4 col-sm-6 col-xs-12">
						<button type="submit" class="btn btn-warning bg-warning btn-block waves-effect"><?php echo e(trans('student.save')); ?></button>
					</div>
				</div>
			</div>
