    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="/main"><?php echo e(trans('frontend.main')); ?></a></li>
                    <li><a href="/news/"><?php echo e(trans('frontend.news')); ?></a></li>
                ...
                <div class="card-panel text-center hoverable">
                    ...
                    <div class="info">
                        <span><i class="fa fa-clock-o"></i><?php echo e($data->created_at); ?></span>
                    </div>					
                            ...
                            <div id="rev_slider_30_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="media-carousel-autoplay30" style="margin: 0px auto; background-color: rgb(38, 41, 43); padding: 0px; height: 405px; overflow: visible;">
								...
								<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
									...
									<div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">				
										...
										<div>
											<img class="text-center" src="<?php echo e(asset($img)); ?>" ></img>
										</div>
                    ...
                    <div class="news-text">
                        <p></p><p><strong><?php echo e($data->des); ?></strong></p><p></p>

                        <div class="share-article text-center">
                            <label for="heading"><?php echo e(trans('frontend.You_can_share_social_media_networks')); ?></label>
