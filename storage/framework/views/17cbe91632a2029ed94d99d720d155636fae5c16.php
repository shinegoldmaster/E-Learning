...
<html lang="<?php echo e(config('app.locale')); ?>">
	...
	<head>
		<title><?php echo e(trans ('global.student')); ?>|<?php echo e(trans ('global.dashboard')); ?></title>
		<meta charset="UTF-8">
            ...
            <div class="content">
                <div class="title m-b-md">
										...
										<?php if(Auth::check()): ?>
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu notification-drop messages" role="menu">
													<li>
														<div class="read-more">												
															<a href="/student/msgs-received" class="btn btn-warning"><?php echo e(trans ('global.see_more')); ?></a>
														</div>
													</li>
												</ul>
											</li>
					...
					<!-- end banner -->
					 ...
					 <?php echo $__env->yieldContent('student-dashboard'); ?>
