...
<head>
	...
	<link href="<?php echo e(asset('css/voicechat/bootstrap.min.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('css/voicechat/styles.css')); ?>" rel="stylesheet">    
</head>
    ...
    <div class="row">
        ...
        <div class="col-sm-12" style="display:none">
            <div id="my-number-section" class="text-center">
                <div id="my-number"><?php echo e(trans('layout.LOADING')); ?></div>
                
                <div id="my-number-permalink" >
                    <span class="glyphicon glyphicon-link"></span>
                    <?php echo e(trans('layout.call_link')); ?>:
        ...
        <div class="col-sm-12">
                ...
                <div class="col-sm-12 col-xs-12 dial-buttons text-center">
                    <button id="dial" class="btn btn-primary">
                        <?php echo e(trans('layout.accept')); ?>

                    </button>
                   
                    <button id="hangup" class="btn btn-danger">
                        <?php echo e(trans('layout.decline')); ?>
...
<!-- WebRTC SDK -->
<script src="<?php echo e(asset('js/voicechat/webrtc.js')); ?>"></script>
<script src="<?php echo e(asset('js/voicechat/sound.js')); ?>"></script>
<script>(function(){
