    ...
    <div id="user-info" class="register">
		...
		<div class="row more-info">
			...
			<div class="col-md-8 col-md-offset-2 col-sm-12">
				...
				<div class="input-field col-md-6 col-sm-6 col-xs-12">
					<a href = "<?php echo e(route('instructorzoomrequest')); ?>" class="btn btn-warning bg-warning btn-block waves-effect"> Send Request </a>
				</div>
				 
				<div class="input-field col-md-6 col-sm-6 col-xs-12">
					 <a href = "<?php echo e(route('instructorzoomcheck')); ?>"  class="btn btn-warning bg-warning btn-block waves-effect"> Check </a>
				</div>
				<div class="clearfix"></div>
			</div>
			<?php endif; ?>
