  ...
  @section('frontend-content')      					
	...
	<section id="content">       
		...
		<section class="home-about _v2 rlt">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12 @if(config('app.locale')  != 'en') pull-right @endif">
						<div class="view overlay">
							<img src="{{ asset('images/homepage/about-img.jpg') }}" class="img-responsive" alt="" width="767" height="400">
						</div>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<a href="/about" class="btn waves-effect waves-light btn-round">{{trans('frontend.See_More')}}</a>
					</div>
				</div>
			</div>
		</section>
		...
		<div class="slider-news _v2">
			...
			<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
				...
				<div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
					...
					<div>
						<img data-u="image" src="{{ asset('images/slider/slider4.jpg') }}" />
					</div>
					<div>
		...
		<section class="features _v2">
			<div class="container">
				{{--
				<div class="section-title">
					<h3>{{trans('frontend.Almaqraa_Features')}}</h3>
				</div>
				--}}
				<div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="card hoverable bg-info padding-20">
							<img src="{{ asset('images/homepage/feature-icon-1.png') }}" class="img-responsive" alt="" width="50" height="45">
							<h4>{{trans('frontend.Direct_Instruction')}}</h4>
							<p>{{trans('frontend.The_ability_directly_teachers')}}</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="card hoverable bg-warning padding-20">
							<img src="{{ asset('images/homepage/feature-icon-2.png') }}" class="img-responsive" alt="" width="50" height="45">
							<h4>{{trans('frontend.Intervuew')}}</h4>
							<p>{{trans('frontend.Having_interview_level_learners')}}</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="card hoverable bg-danger padding-20">
							<img src="{{ asset('images/homepage/feature-icon-3.png') }}" class="img-responsive" alt="" width="50" height="45">
							<h4>{{trans('frontend.Multi_levels')}}</h4>
							<p>{{trans('frontend.There_levels_academic_learners')}}</p>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="how-work _v2 text-center">
			<div class="container">
				<div class="section-title _v2">
					<h3>{{trans('frontend.How_Al_Maqraa_work')}}</h3>
				</div>
				<div class="row">
					<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="circle">
							...
							<h4>{{trans('frontend.First_Register')}}</h4>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="circle">
							...
							<h4>{{trans('frontend.Then_Choose_suitable_dates')}}</h4>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="circle">
							...
							<h4>{{trans('frontend.Listen_Carefuly')}}</h4>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="circle">
							<div class="circle-icon last">
								<img src="{{ asset('images/homepage/user-icon.png') }}" class="img-responsive" alt="" width="50" height="88">
							</div>
							<h4>{{trans('frontend.Repeat_after_Sheikh')}}</h4>
						</div>
					</div>
				</div>
			</div>
		...
		<!--===== End How It Work ======-->
			...
			<div class="container">
				<div class="section-title _v2">
					<h3>{{trans('frontend.Available_Appointments')}}</h3>
				</div>
				<div class="row">
					<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
						<ul class="nav nav-tabs tabs-2" data-tabs="tabs">
							<li class="active">
									...
									{{trans('frontend.individual_programs')}}
								</a>
							</li>
							<li>
								<a data-toggle="tab" href="#collective_programs">
									<img src="{{ asset('images/homepage/people.png') }}" class="img-responsive" alt="" width="35" height="35">
									{{trans('frontend.collective_programs')}}
								</a>
							</li>
						</ul>
					</div>
									...
									<div class="media hoverable">
										...
										<div class="media-body">
											...
											<div class="btn-wrapper" data-toggle="tooltip" data-placement="top" title="">
													...
													@if (Auth::check())     	
														<button type="submit" class="btn btn-xs btn-warning ">{{trans('instructorsshow.join_now')}}</button>
													@else
														<button type="submit" class="btn btn-xs btn-warning " disabled="disabled">{{trans('instructorsshow.join_now')}}</button>
													@endif
													</form>
				...
				<div class="all-time text-center margin-top-25">
					<a href="/program/" class="btn bg-danger btn-round waves-effect">{{trans('frontend.all_appointment')}}</a>
				</div>
				{{--
